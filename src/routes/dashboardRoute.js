...
<body>
    ...
    <div id="tab-dashboard" class="tab-content active">
        ...
        <div class="section" style="margin-top:16px;">
            <h2 style="text-align:center;font-size:16px;font-weight:600;color:var(--text-primary);letter-spacing:0.5px;margin-bottom:18px;">צפיות ולידים לאורך זמן</h2>
            <div style="position:relative;height:260px;"><canvas id="chart-views-leads"></canvas></div>
        </div>
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:16px;">
            <div class="section">
                <h2 style="text-align:center;font-size:14px;font-weight:600;color:var(--text-primary);margin-bottom:10px;">ביצועים לפי סוג נכס</h2>
                <div style="position:relative;height:220px;"><canvas id="chart-radar"></canvas></div>
            </div>
            <div class="section">
